                ...
                >
                  <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                    <div className="flex items-center justify-between w-full md:w-auto">
                      <a href="#">
                        <span className="text-2xl tracking-tight font-extrabold text-gray-900">
                          Shortly
                        </span>
                      </a>
                  ...
                  <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                    ...
                    <a
                      href="#"
                      className="font-medium text-white border border-transparent rounded-full bg-teal-400 hover:bg-teal-500 md:py-2 md:text-md md:px-3"
                    >
                      Sign up
                    </a>
                  </div>
              ...
              <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md">
                    <a
                      href="#"
                      className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-teal-400 hover:bg-teal-500 md:py-2 md:text-lg md:px-10"
                    >
                      Get started
                    </a>
                  </div>
